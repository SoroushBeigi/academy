...
class NewContentWidgetWeb extends StatefulWidget {
  const NewContentWidgetWeb({super.key});

  @override
  State<NewContentWidgetWeb> createState() => _NewContentWidgetWebState();
}

class _NewContentWidgetWebState extends State<NewContentWidgetWeb> {
