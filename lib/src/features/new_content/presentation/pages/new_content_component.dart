...
class _NewContentComponentState extends State<NewContentComponent> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) => getIt<NewContentCubit>()..getAllContents(),
      child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ACElevatedButton(
                                ...
                                child: Text(textLocalization.accept, style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Theme.of(context).colorScheme.surface),),
                              )
                            ],
                          ),
                        ),
