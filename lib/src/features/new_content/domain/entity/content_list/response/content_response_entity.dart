class ContentResponseEntity {
  ...
  factory ContentResponseEntity.fromJson(Map<String, dynamic> json) {
    return ContentResponseEntity(
      ...
      relatedContentIds: json['related_content_ids'] != null  ? List<int>.from(json['related_content_ids']) : null,
    );
  }
