...
import '../core/data/local/shared_pref.dart' as _i9;
...
import '../features/favourite/presentation/cubit/favourite_cubit.dart' as _i12;
import '../features/home/presentation/bloc/home_cubit.dart' as _i10;
import '../features/profile/presentation/cubit/profile_cubit.dart' as _i6;
import '../features/search/presentation/cubit/search_cubit.dart' as _i11;
import '../features/splash/presentation/bloc/splash_cubit.dart' as _i7;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i8.VideoDetailsCubit>(() => _i8.VideoDetailsCubit());
  ...
  gh.singleton<_i12.FavouriteCubit>(() => _i12.FavouriteCubit());
  return getIt;
}
